...
INSERT INTO `ecommerce`.`assignor` (`idAssignor`, `Description`, `PaymentType`, `OurNumber_Start`, `OurNumber_Emd`, `Wallet`, `Date_Start`, `Date_End`, `BankAccount_idBankAccount`, `BankAccount_Bank_idBank`, `PaymentType_idPaymentType`)
...
VALUES ('1', 'TOMASIA OLIVEIRA DE ANDRADE', '62753894201', 'F', ''),
		('2', 'JOAO MACHADO SILVA', '42109538477', 'F', ''),
        ('3', 'ANA MARIA VIEIRA DE LIMA', '57100328465', 'F', ''),
        ('4', 'RODRIGO SANTOS DE AZEVEDO', '67481999230', 'F', ''),
        ('5', 'LUIZA GARCIA MATOS', '99002064485', 'F', '');
